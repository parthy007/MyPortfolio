...
const greetTextContainer = document.querySelector(".greetTextContainer");
const greetImgContainer = document.querySelector(".greetImgContainer");
const userName = document.querySelector(".name");
const jobTitleContainers = document.querySelectorAll(".jobTitleContainer");
const jobTitle = document.querySelector(".jobTitle")
const jobTitleSecond = document.querySelector(".jobTitleSecond")
...
window.addEventListener("scroll", ()=>{
    ...
    greetTextContainer.style.transform = `translateY(${offSetY * 0.2}px)`;
    greetImgContainer.style.transform = `translate(${offSetY * 0.4}px,${offSetY * 0.7}px)`;
    userName.style.transform = `translateX(calc(-15vh + ${offSetY * 0.1}px))`;
    ...
    jobTitleSecond.style.transform = `translateX(calc(-300vh + ${offSetY}px))`
    projectsTitle.style.transform = `translateY(calc(400vh - ${offSetY * 0.9}px))`
    laptops[0].style.transform = `translateX(calc(480vh - ${offSetY}px))`
    phone.style.transform = `translateX(calc(-590vh + ${offSetY}px))`
    laptops[1].style.transform = `translateX(calc(740vh - ${offSetY}px))`
})